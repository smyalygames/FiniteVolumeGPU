    ...
    def substep_dimsplit(self, dt, substep, external, internal):
        if external and internal:
            ...
            self.handler.prepared_call(self.grid_size, self.block_size, self.stream,
                                       ...
                                       self.u0[0].data, self.u0[0].get_pitch(),
                                       self.u0[1].data, self.u0[1].get_pitch(),
                                       self.u0[2].data, self.u0[2].get_pitch(),
                                       self.u0[3].data, self.u0[3].get_pitch(),
                                       self.u1[0].data, self.u1[0].get_pitch(),
                                       self.u1[1].data, self.u1[1].get_pitch(),
                                       self.u1[2].data, self.u1[2].get_pitch(),
                                       self.u1[3].data, self.u1[3].get_pitch(),
